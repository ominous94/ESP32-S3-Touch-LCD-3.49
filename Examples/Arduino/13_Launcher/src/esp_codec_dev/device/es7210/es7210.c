 ...
 *           lrckl:      0x05
 */
static const struct _es7210_coeff_div es7210_coeff_div[] = {
...
static int es7210_get_coeff(uint32_t mclk, uint32_t lrck)
{
    for (int i = 0; i < (sizeof(es7210_coeff_div) / sizeof(es7210_coeff_div[0])); i++) {
